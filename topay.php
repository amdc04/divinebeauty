            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <form id="contact" action="" method="get">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <fieldset>
                                        <select style="border-radius: 5px; padding: 10px; margin-left: 4%;"
                                            id="form_type" name="form_type">
                                            <option>MAN-icure(45$) - For Him</option>
                                            <option>Polish Only(17$) - For Her</option>
                                            <option>Shape and Polish(25$) - For Her</option>
                                            <option>Manicure or Pedicure(25$) - For Her</option>
                                        </select>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <fieldset>
                                    <input type="date" name="form_date" id="form_date" min="2021-05-27" max="2021-12-10"
                                        step="1" />
                                </fieldset>
                            </div>
                    ...
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <table>
                            <tr>
                                <td><input type="hidden" name="on0" value="Service">Service</td>
                            </tr>
                            <tr>
                                <td><select name="os0">
                                        ...
                                        <option value="Shape & Polish - For Her">Shape & Polish - For Her $25.00 USD
                                        </option>
                                        <option value="Manicure or Pedicure - For Her">Manicure or Pedicure - For Her
                                            $30.00 USD</option>
                                    </select> </td>
                            </tr>
                        </table>
                        ...
                        <input type="image"
                            ...
                            name="submit" alt="PayPal, the safest and fastest way to pay online.">
                        <br>
                        <img src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/cc-badges-ppmcvdam.png"
                            alt="Buy now with PayPal"></br>
                    </form>
