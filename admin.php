            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    if ($nacc > 0) {
                        ...
                        echo "
                        <div class='col-lg-1 col-md-1 col-sm-1 align-self-center' data-scroll-reveal='enter left move 30px over 0.6s after 0.4s'>
                    ...
                    <div class='col-lg-3 col-md-3 col-sm-3'>
                        ...
                        <div class=' col-lg-6 col-md-6 col-sm-6 left-text'>
                            <p> 
                    ...
                    ";
                        ...
                        <h2 style='margin-left: 25%; ''> no <h2> users </h2></h2>
                    </div>";
                    }
